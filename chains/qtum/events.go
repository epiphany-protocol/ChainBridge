...
func (l *listener) handleErc20DepositedEvent(destId msg.ChainId, nonce msg.Nonce) (msg.Message, error) {
	...
	record, err := l.erc20HandlerContract.GetDepositRecord(&bind.CallOpts{From: l.conn.FromAddress()}, uint64(nonce), uint8(destId))
	if err != nil {
...
func (l *listener) handleErc721DepositedEvent(destId msg.ChainId, nonce msg.Nonce) (msg.Message, error) {
	...
	record, err := l.erc721HandlerContract.GetDepositRecord(&bind.CallOpts{From: l.conn.FromAddress()}, uint64(nonce), uint8(destId))
	if err != nil {
...
func (l *listener) handleGenericDepositedEvent(destId msg.ChainId, nonce msg.Nonce) (msg.Message, error) {
	...
	record, err := l.genericHandlerContract.GetDepositRecord(&bind.CallOpts{From: l.conn.FromAddress()}, uint64(nonce), uint8(destId))
	if err != nil {
